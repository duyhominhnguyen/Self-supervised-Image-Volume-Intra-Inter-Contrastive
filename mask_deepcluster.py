...
logger = getLogger()
parser = argparse.ArgumentParser(description="Implementation of MASK-deepcluster-universal")

#########################
## changed parameters ###
#########################
parser.add_argument("--log_dir", type=str, default= './log/' , help="path to log file")
parser.add_argument("--tensorboard_name", type=str, default= "universal_mask_deepcluster", help="name of tensorboard folder")
